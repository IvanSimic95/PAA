...
if($obj->lineItems[0]->itemNo == "14"){
  ...
  if ($conn->query($sql) === TRUE) {
    ...
    $sql = "UPDATE `orders` SET `order_status`='paid',`cb_email`='$order_email',`premium`='$premiumReading',`buygoods_order_id`='$order_buygoods',`zip`='$zip',`country`='$country' WHERE order_id='$mOrderID'" ;
