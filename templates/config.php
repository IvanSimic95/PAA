...
$processingWelcome = "We are now processing your Order #%ORDERID% & your order will be delivered to your email in %PRIORITY% hours or less. If this is your first order your new account will be created. In order to login to your account just click the button below.";
