                    ...
                    <div class="py-2 px-0 light topbar-gradient rounded-3">
                        ...
                        <div id="sidebar-menu" class="text-white">
                            ...
                            ?> </div>
                                ...
                                <li class="active"> <a href="/dashboard/support"
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="link position-relative">
                                                Support
                                                <span id="notifier-badge"
                                                    class="position-absolute badge rounded-pill bg-danger">0</span>
                                            </div>
                                            <div class="link-desc">Need help with something?</div>
                                        </div>
                                    </a> </li>
                                <li> <a href="/dashboard?logout=yes"
                                        class="text-decoration-none d-flex align-items-start">
                        ...
                        <div class="card mb-3 p-0">
                            <div class="card-header bg-light p-4 py-3 topbar-gradient">
                                <div class="d-flex flex-between-center">
                                    <h3 class="mb-0 fw-semibold fs-1" style="color:#fff;">Support Chat - Not Started Yet
                                    </h3>
                                </div>
                            </div>
                            <div class="card-body px-1 px-md-2 px-lg-3 py-2">
                                ...
                                <div class="alert alert-info border-2 d-flex align-items-center mt-1" role="alert">
                                    <div class="bg-info me-3 icon-item d-none d-sm-flex"><span
                                            class="fas fa-info-circle text-white fs-3"></span></div>
                                    <p class="mb-0 flex-1">If you need help and wish to start the chat just click the
                                        button below!</p>
                                </div>
