    ...
    <section class="py-0 light" id="banner">
            ...
            <div class="row g-0">
                ...
                <div class="col-12 offset-0 col-xl-8 offset-xl-2">
                    ...
                    <div class="alert alert-success border-2 d-flex align-items-center" role="alert">
                        <div class="bg-success me-3 icon-item d-none d-sm-flex"><span
      ...
      <p class="mb-0 flex-1">Please note that your Purchase Will Be Reflected as "Digistore24"</p>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body col-12 offset-0 col-xl-10 offset-xl-1 mt-0"
                            style="text-align:center; min-height:25vh;">
                            ...
                            <div class="alert alert-info border-2 d-flex align-items-center mt-2" role="alert">
                                <p class="mb-0 flex-1">It's time to head over to your <b>User Dashboard!</b> <br> Please
                                    click the button below!</p>
                            </div>

                            <a href="<?php echo "/dashboard?login=yes&check_email=".$_SESSION['userEmail']; ?>"
                                id="DashboardLogin"
                                class="btn btn-shadow btn-dark text-capitalize w-100 mt-2 mb-3 fs-1 fw-bold fs-1"><i
                                    class="fa fa-user"></i> User Dashboard!</a>
                            <?php } ?>
                            ...
                            <?php if($DBsaved == 0){ ?>
                            <form id="completeOrder" class="form-order needs-validation display-block text-start"
                                name="completeOrder" action="?updateInfo=Yes" method="post">
                                <div class="row g-2">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-2 form-floating-icon mb-3">
                                            ...
                                            <?php if($formDate == "US"){ ?>
                                            <input class="form-control" id="userDobUS" name="userDobUS"
                                                placeholder="MM/DD/YYYY" required
                                                value="<?php echo $_SESSION['dobUS']; ?>" />
                                ...
                                <div class="row g-2">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" id="SelectGender" aria-label="SelectGender"
                                                required="" name="gender">
                                                <option <?php if($_SESSION['gender']=="male")echo 'selected=""'; ?>
                                                    value="male"><span class="fa fa-user"></span> Male</option>
                                                <option
                                                    <?php if($_SESSION['gender']=="female")echo 'selected=""'; ?>value="female">
                                                    Female</option>
                                                <option
                                                    <?php if($_SESSION['gender']=="nonbinary")echo 'selected=""'; ?>value="nonbinary">
                                                    Non-Binary</option>
                                            </select>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating form mb-3">
                                            <select class="form-select" id="SelectPGender" aria-label="SelectPGender"
                                                required="" name="pgender">
                                                <option
                                                    <?php if($_SESSION['partnerGender']=="male")echo 'selected=""'; ?>
                                                    value="male"><span class="fa fa-user"></span> Male</option>
                                                <option
                                                    <?php if($_SESSION['partnerGender']=="female")echo 'selected=""'; ?>value="female">
                                                    <span class="fa fa-user"></span> Female</option>
                                                <option
                                                    <?php if($_SESSION['partnerGender']=="nonbinary")echo 'selected=""'; ?>value="nonbinary">
                                                    Non-Binary</option>
                                                <option
                                                    <?php if($_SESSION['partnerGender']=="any")echo 'selected=""'; ?>value="any">
                                                    Any Gender</option>
                                            </select>
                                ...
                                <button id="SaveChanges" type="submit" name="form_submit"
                                    class="btn btn-submit-form btn-primary btn-shadow w-100 btn-add-to-cart mb-1 mt-1 fw-bold fs-1"
                                    value="Save Changes!" disabled><i class="fa fa-square-check"></i> Save
                                    This!</button>
                                <a href="<?php echo "/dashboard?login=yes&check_email=".$_SESSION['email']; ?>"
                                    id="SkipChanges"
                                    class="btn btn-shadow btn-dark text-capitalize w-100 fs-1 fw-bold fs-1 mb-1 mt-1">
                                    Skip This! <i class="fa fa-forward"></i></a>
                            </form>
                            <?php }?>
