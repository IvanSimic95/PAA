...
$findUser = $_GET['findUser'];
    ...
    $sql5 = "SELECT * FROM users WHERE email = '".$findUser."'";
    ...
    if ($result5){
        $row5 = mysqli_num_rows($result5);
            if ($row5 > 0){
                ...
                $errorDisplay .= " Couldn't find user account with email: ".$findUser."/";
            }
    }
...
if(isset($userID)){
    ...
    if ($result5){
        $row5 = mysqli_num_rows($result5);
            if ($row5 > 0){
                ...
                $errorDisplay .= " User ID was provided but it couldnt have been found in DB ".$userID."/";
            }
    }
    ...
    $errorDisplay .= " User ID variable isn't defined";
}
